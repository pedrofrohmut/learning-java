...
public class SetTodoIsNotDoneUseCase {

    private final IUsersDataAccess usersDataAccess;
    private final ITodosDataAccess todosDataAccess;

    public SetTodoIsNotDoneUseCase(IUsersDataAccess usersDataAccess, ITodosDataAccess todosDataAccess) {
    ...
    public void execute(String todoId, String authUserId)
        ...
        TodoEntity.setTodoIsNotDone(todoId, this.todosDataAccess);
