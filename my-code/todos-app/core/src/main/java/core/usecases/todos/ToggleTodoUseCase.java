...
public class ToggleTodoUseCase {
    ...
    public ToggleTodoUseCase(IUsersDataAccess usersDataAccess, ITodosDataAccess todosDataAccess) {
    ...
    public void execute(String todoId, String authUserId)
        ...
        TodoEntity.toggleTodo(todo, this.todosDataAccess);
        System.out.println("[Info] Todo isDone toggled");
    }
}
