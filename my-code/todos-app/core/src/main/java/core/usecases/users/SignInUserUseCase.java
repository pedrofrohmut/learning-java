...
public class SignInUserUseCase {
    ...
    public SignInUserUseCase(IUsersDataAccess usersDataAccess, IPasswordService passwordService,
    ...
    public SignedUserDto execute(SignInFormDto form)
        ...
        final var userDb = UserEntity.findUserByEmail(form.email, this.usersDataAccess);
        ...
        final var signInToken = UserEntity.createSignInToken(userDb.id, this.jwtService);
