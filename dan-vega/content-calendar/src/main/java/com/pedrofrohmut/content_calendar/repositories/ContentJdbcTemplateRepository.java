...
public class ContentJdbcTemplateRepository {
    ...
    public void createContent(String title, String desc, Status status, ContentType contentType, String URL) {
    ...
    public void updateContent(int id, String title, String desc, Status status, ContentType contentType, String URL) {
